...
# Accelerated Version
We have accelerated our code! The new code is in `jtnn/`, and the VAE training auxiliaries is in `auxiliaries/`. Please refer to `auxiliaries/README.md` for details.
...
* `jtnn/` contains codes for model implementation.
* `auxiliaries/` contains codes for VAE training. Please refer to `auxiliaries/README.md` for details.
